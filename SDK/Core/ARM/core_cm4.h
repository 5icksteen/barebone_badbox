...
#define __CM4_CMSIS_VERSION_MAIN (5U)                                                     /*!< \deprecated [31:16] CMSIS HAL main version */
#define __CM4_CMSIS_VERSION_SUB (4U)                                                      /*!< \deprecated [15:0]  CMSIS HAL sub version */
 ...
 */
  __STATIC_INLINE void __NVIC_SetPriorityGrouping(uint32_t PriorityGroup)
  {
    ...
    SET_BIT(reg_value, (uint32_t)(SCB_AIRCR_VECTKEY_Msk | SCB_AIRCR_PRIGROUP_Msk));                                        /* clear bits to change               */
 ...
 */
  __STATIC_INLINE uint32_t NVIC_EncodePriority(uint32_t PriorityGroup, uint32_t PreemptPriority, uint32_t SubPriority)
  {
    ...
    return (
        ((PreemptPriority & (uint32_t)((1UL << (PreemptPriorityBits)) - 1UL)) << SubPriorityBits) | ((SubPriority & (uint32_t)((1UL << (SubPriorityBits)) - 1UL))));
  }
